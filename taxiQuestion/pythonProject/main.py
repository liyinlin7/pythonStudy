...
from controller.paper_opt import paper_opt
...
# CORS(app, resources={r"/paper_opt/*": {"origins": "http://127.0.0.1:8080", "supports_credentials": True}})
# CORS(app, resources={r"/questions_opt/*": {"origins": "http://127.0.0.1:8080", "supports_credentials": True}})
# CORS(app, resources={r"/*": {"origins": "*"}})
# import config

# 注册蓝图，并指定其对应的前缀（url_prefix）
# app.register_blueprint(user_opt, url_prefix="/user_opt")
app.register_blueprint(paper_opt, url_prefix="/paper_opt")
