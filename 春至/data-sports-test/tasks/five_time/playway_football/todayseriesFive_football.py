...
class TodaySeries_football(object):
    ...
    def today_series_id_1(self):
        ...
        '''
        sql = '''
                 SELECT * FROM `sports-soccer-match`.ex_match  where source=2  and p_id != 0 and match_start_time >= (UNIX_TIMESTAMP() - 3600*12)
        ...
        if len(series_ex_id_str) != 0:
            ...
            if self.env_flag == 0:
                ...
                market_res = DoMySql().select_rate(cnn=self.cnn_rate, sql=mark_sql, env_flag=self.env_flag)
    ...
    def today_option(self, market_res):
        ...
        try:
            ...
            if self.env_flag == 0:
                ...
                option_res = DoMySql().select_rate(cnn=self.cnn_rate, sql=sql, env_flag=self.env_flag)
    ...
    def today_market_type_option_status(self, datas):
        ...
        try:
            ...
            if self.env_flag == 0:
                ...
                option_res = DoMySql().select_rate(cnn=self.cnn_rate, sql=option_sql, env_flag=self.env_flag)
...
if __name__ == '__main__':
    t = TodaySeries(env_flag=0).today_series_id_1()
