...
class FootballUpdate(object):
    ...
    def __init__(self, env_flag):
        self.PRO_config = {'host': '172.16.0.153',     # 172.16.0.153：3306 内网ID ； 47.57.231.50：856  公网IP。
                  'user': 'root',
    ...
    def update_football_mathc(self):
        sql = '''
            update  `sports-soccer-match`.ex_match set audit =3 where  match_start_time <=  unix_timestamp()-3600*2  and audit=1  and p_id = 0;
        '''
