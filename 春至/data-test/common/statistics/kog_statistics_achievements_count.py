...
from common.requestApi.kog_statistics_achievements import achievements


class achievements_count(object):
    '''
        最近交战统计计算
    '''
    def mysql_achievements_connt(self ,team_id, series_id, stats_date, stats_count, special_stats,
                                 game_id=4, status=0, query_type=1, stats_type=1):
        '''
