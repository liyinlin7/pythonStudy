...
class TeamID_test(object):
    ...
    def play_team_series_team(self):
        ...
        '''
        sql = '''
             SELECT * FROM `data-center`.ex_series where game_id in (1,2,3,4) and start_time > unix_timestamp() - 3600*24*1 and p_id !=0 and source=1;
        '''
        ...
        print("不一致的队伍比赛ID：", err_team_id_ex_id)
        print("雷竞技没有队伍ID 的系列赛ID：", null_level_id)
