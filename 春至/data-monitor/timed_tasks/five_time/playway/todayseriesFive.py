...
class TodaySeries(object):
    ...
    def today_market_type_option_status(self, datas):
        ...
        try:
            ...
            if self.env_flag == 'release':
                option_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=option_sql)
            elif self.env_flag == 'develop':
                option_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=option_sql)
    ...
    def todya_match_id(self):
        ...
        try:
            ...
            kog_sql = '''
                    ...
                    '''
            lol_datas = self.doMysql.select_centon(cnn=self.cnn_centon, sql=lol_sql)
            dota_datas = self.doMysql.select_centon(cnn=self.cnn_centon, sql=dota_sql)
            csgo_datas = self.doMysql.select_centon(cnn=self.cnn_centon, sql=csgo_sql)
            kog_datas = self.doMysql.select_centon(cnn=self.cnn_centon, sql=kog_sql)
            ...
            if len(lol_match_id_list) != 0:
                ...
                if self.env_flag == 'release':
                    lol_market_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=lol_market_sql)
                elif self.env_flag == 'develop':
                    lol_market_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=lol_market_sql)
                ...
                if len(lol_market_id_list) != 0:
                    ...
                    if self.env_flag == 'release':
                        lol_market_type_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=lol_market_type_sql)
                    elif self.env_flag == 'develop':
                        lol_market_type_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=lol_market_type_sql)
                    ...
                    if len(lol_market_type_id_list) != 0:
                        ...
                        if self.env_flag == 'release':
                            lol_option_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=lol_option_sql)
                        elif self.env_flag == 'develop':
                            lol_option_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=lol_option_sql)
            ...
            if len(dota_match_id_list) != 0:
                ...
                if self.env_flag == 'release':
                    dota_market_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=dota_market_sql)
                elif self.env_flag == 'develop':
                    dota_market_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=dota_market_sql)
                ...
                if len(dota_market_id_list) != 0:
                    ...
                    if self.env_flag == 'release':
                        dota_market_type_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=dota_market_type_sql)
                    elif self.env_flag == 'develop':
                        dota_market_type_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=dota_market_type_sql)
                    ...
                    if self.env_flag == 'release':
                        dota_option_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=dota_option_sql)
                    elif self.env_flag == 'develop':
                        dota_option_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=dota_option_sql)
            ...
            if len(csgo_match_id_list) != 0:
                ...
                if self.env_flag == 'release':
                    csgo_market_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=csgo_market_sql)
                elif self.env_flag == 'develop':
                    csgo_market_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=csgo_market_sql)
                ...
                if len(csgo_market_id_list) != 0:
                    ...
                    if self.env_flag == 'release':
                        csgo_market_type_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=csgo_market_type_sql)
                    elif self.env_flag == 'develop':
                        csgo_market_type_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=csgo_market_type_sql)
                    ...
                    if self.env_flag == 'release':
                        csgo_option_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=csgo_option_sql)
                    elif self.env_flag == 'develop':
                        csgo_option_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=csgo_option_sql)
            ...
            if len(kog_match_id_list) != 0:
                ...
                if self.env_flag == 'release':
                    kog_market_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=kog_market_sql)
                elif self.env_flag == 'develop':
                    kog_market_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=kog_market_sql)
                ...
                if self.env_flag == 'release':
                    kog_market_type_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=kog_market_type_sql)
                elif self.env_flag == 'develop':
                    kog_market_type_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=kog_market_type_sql)
                ...
                if self.env_flag == 'release':
                    kog_option_res = self.doMysql.select_basic(cnn=self.cnn_basic, sql=kog_option_sql)
                elif self.env_flag == 'develop':
                    kog_option_res = self.doMysql.select_centon(cnn=self.cnn_centon, sql=kog_option_sql)
...
if __name__ == '__main__':
    ...
    t = TodaySeries('develop', cnn_centon, cnn_basic).todya_match_id()
