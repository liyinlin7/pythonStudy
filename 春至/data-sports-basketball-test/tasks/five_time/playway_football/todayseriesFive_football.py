...
class TodaySeries_football(object):
    '''
        雷竞技的系列赛
    '''
    ...
    def today_series_id_1(self):
        ...
        '''
        sql = '''
                 SELECT * FROM `sports-soccer-match`.ex_match  where source in (6,7)  and p_id != 0 and match_start_time >= (UNIX_TIMESTAMP() - 3600*12)
                 and match_start_time < (UNIX_TIMESTAMP() + 3600*12);
             '''
    ...
    def today_option(self, market_res):
        ...
        try:
            ...
            err_str = '足球：当天所有系列赛的option表中(market_type_id)，'
...
if __name__ == '__main__':
    t = TodaySeries_football(env_flag=1).today_series_id_1()
